...
angular.module('tableSelection', []).constant('tableSelectionConstants', {
  ...
  return {
    ...
    setCurrentScope: function setCurrentScope(newScope) {
      currentScope = newScope;
    }
  };
}).directive('tableSelection', function (tableSelectionConstants) {

  var tableSelectionCtrl = function tableSelectionCtrl($scope, $element) {
    ...
    this.addRow = function (data, element, indexKey) {
      var rowObject = {
        ...
        _toggleStatus: function _toggleStatus() {
  ...
  var tableSelectionRowLink = function tableSelectionRowLink(scope, element, attrs, parentCtrl) {
